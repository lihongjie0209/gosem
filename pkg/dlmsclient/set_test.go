...
func TestClient_SetRequestWithDataBlock(t *testing.T) {
	...
	sendReceive(tm, rdc, "C102C1000300015E230BFF020000000000016B020A092800010203040506070809000102030405060708090001020304050607080900010203040506070809092800010203040506070809000102030405060708090001020304050607080900010203040506070809092800010203040506070809000102030405060708", "C501C100")
	sendReceive(tm, rdc, "C103C100000000027509000102030405060708090001020304050607080909280001020304050607080900010203040506070809000102030405060708090001020304050607080909280001020304050607080900010203040506070809000102030405060708090001020304050607080915000000000000007B150000", "C501C100")
	sendReceive(tm, rdc, "C103C10100000003210000000000EA1500000000000001591500000000000001C8150000000000000237", "C503C10000000003")

	err := c.SetRequest(dlms.CreateAttributeDescriptor(3, "0-1:94.35.11.255", 2), data)
	assert.NoError(t, err)

	// Some conforming meters, including GuruxDLMS.c, acknowledge the final
	// block with SetResponseNormal rather than SetResponseLastDataBlock.
	...
	sendReceive(tm, rdc, "C103C10100000003210000000000EA1500000000000001591500000000000001C8150000000000000237", "C501C100")
	err = c.SetRequest(dlms.CreateAttributeDescriptor(3, "0-1:94.35.11.255", 2), data)
	assert.NoError(t, err)
